...
train = DataLoader(datasets.MNIST('./data', train=True, download=False, transform=tx),
                       batch_size=batch_size, shuffle=True, **kwargs)
test = DataLoader(datasets.MNIST('./data', train=False, download=False, transform=tx),
                      batch_size=batch_size, shuffle=True, **kwargs)
...
if __name__ == '__main__':
    modelsave_path = '/3.7TB/xal/pretrained_classifer_model/' + 'MNIST_classifer'
